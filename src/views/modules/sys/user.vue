...
<!--      <el-table-column
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-tag v-if="scope.row.status === 0" size="small" type="danger">否</el-tag>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      export2Excel(){
        const tHeader  = ['姓名','工号','用户名','邮箱','手机号','状态','对应仓库','对应部门']
        const filterVal = ['name','jobNum','username','mobile','email', 'status','houseShow', 'deptShow']
        exportExcel(tHeader,filterVal,this.dataList)
      }
    }
  }
</script>
